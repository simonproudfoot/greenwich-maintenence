 ...
 * Plugin URI: https://www.greenwich-design.co.uk/
 ...
 * Author URI:https://www.greenwich-design.co.uk/
 */


// Schedule cron on plugin activation
register_activation_hook(__FILE__, 'greenwich-wp_schedule_cron');

// Unschedule cron on plugin deactivation
register_deactivation_hook(__FILE__, 'greenwich-wp_unschedule_cron');
